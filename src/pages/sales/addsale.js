...
import { Btn, CInput, Picker, Txt,HAND_ACCOUNT, get_error_string, CheckBox, get_date, setSearchPickerDefaulValue  } from '../../components/general';
     ...
     <>
        <div style={{}}>
          ...
          <div className='card' style={{padding:16}}>
              ...
              <h4  class="card-title mg-b-2 mt-2 mb-4" style={{flex:1}}>Add Payment</h4>
              </div>
            <div>
            <CheckBox 
